...
def main():
    ...
    #forecast   = forecast.sort_values("ds") # !!!!!! needs to be read after the forecast is created and saved in BigQuery
    ...
    with col2:
        ...
        # Filter the data for specified date range
        fearngreed.index = pd.to_datetime(fearngreed.index)
